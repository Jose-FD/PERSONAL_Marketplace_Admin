                ...
                foreach($data as $key => $value){
                    ...
                    if($_GET["text"] == "flat"){
                        ...
                        if($_GET["idAdmin"] == $value->id_user_store){
                            ...
                            <a href='/tiendas/editar/".base64_encode($value->id_store."~".$_GET["token"])."' class='btn btn-warning btn-sm mr-1 rounded-circle'>

                            <i class='fas fa-pencil-alt'></i>

                            </a>

                            <a class='btn btn-danger btn-sm rounded-circle removeItem' idItem='".base64_encode($value->id_store."~".$_GET["token"])."' table='stores' suffix='store' deleteFile='stores/".$value->url_store."/".$value->logo_store."' page='tiendas'>
