                    ...
                    foreach($data as $key => $value){
                        ...
                        if($_GET["text"] == "flat"){
                            ...
                            if($value->status_order == 'pending' && $_GET["idAdmin"] == $value->id_user_store){
                                ...
                                $process_order .= "<a class='btn btn-warning nextProcess' idOrder='".$value->id_order."' processOrder='".base64_encode($value->process_order)."' clientOrder='".$value->displayname_user."' emailOrder='".$value->email_user."' productOrder='".$value->name_product."'>Siguiente Proceso</a>";
