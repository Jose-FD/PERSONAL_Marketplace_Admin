                ...
                $dataJson = '{
                    ...
                    foreach($data as $key => $value){
                        ...
                        if($_GET["text"] == "flat"){
                            ...
                            $actions = "<a href='/subcategorias/editar/".base64_encode($value->id_subcategory."~".$_GET["token"])."' class='btn btn-warning btn-sm mr-1 rounded-circle'>

                                        <i class='fas fa-pencil-alt'></i>

                                        </a>

                                        <a class='btn btn-danger btn-sm rounded-circle removeItem' idItem='".base64_encode($value->id_subcategory."~".$_GET["token"])."' table='subcategories' suffix='subcategory' deleteFile='no' page='subcategorias'>
