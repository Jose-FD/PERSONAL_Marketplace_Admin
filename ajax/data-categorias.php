                ...
                $dataJson = '{
                    ...
                    foreach($data as $key => $value){
                        ...
                        if($_GET["text"] == "flat"){
                            ...
                            $image_category = "<img src='".TemplateController::srcImg()."views/img/categories/".$value->image_category."' class='img-circle' style='width:70px'>";
                            ...
                            $actions = "<a href='/categorias/editar/".base64_encode($value->id_category."~".$_GET["token"])."' class='btn btn-warning btn-sm mr-1 rounded-circle'>

                                        <i class='fas fa-pencil-alt'></i>

                                        </a>

                                        <a class='btn btn-danger btn-sm rounded-circle removeItem' idItem='".base64_encode($value->id_category."~".$_GET["token"])."' table='categories' suffix='category' deleteFile='categories/".$value->image_category."' page='categorias'>
