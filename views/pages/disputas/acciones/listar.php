...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="TablaAdministradores" class="table table-bordered table-striped tableDisputes">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Tienda</th>
...
<!--=====================================================================
    TODO: Ventana modal para responder la disputa
=====================================================================-->
    ...
    <div class="modal-dialog">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" type="text" name="answerDispute" required></textarea>
