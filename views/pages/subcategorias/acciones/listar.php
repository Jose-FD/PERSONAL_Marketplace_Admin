...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            ...
            <a class="btn bg-dark btn-sm" href="/subcategorias/nuevo">Nueva Subcategoria</a>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="TablaAdministradores" class="table table-bordered table-striped tableSubcategories">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Nombre</th>
                    <th>Categoria</th>
                    <th>Lista de Titulos</th>
                    <th>URL</th>
                    <th>Vistas</th>
