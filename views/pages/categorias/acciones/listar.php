...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            ...
            <a class="btn bg-dark btn-sm" href="/categorias/nuevo">Nueva Categoria</a>
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <table id="TablaAdministradores" class="table table-bordered table-striped tableCategories">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Imagen</th>
