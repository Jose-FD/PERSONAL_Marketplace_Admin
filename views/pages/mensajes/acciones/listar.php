...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="TablaAdministradores" class="table table-bordered table-striped tableMessages">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Tienda</th>
...
<!--=====================================================================
    TODO: Ventana modal para responder la pregunta
=====================================================================-->
    ...
    <div class="modal-dialog">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" type="text" name="answerMessage" required></textarea>
            ...
            <div><button type="submit" class="btn btn-dark">Enviar</button></div>
