...
<div class="card">
    ...
    <div class="card-footer bg-transparent">
        ...
        <div class="row">
            ...
            <input type="text" class="knob" data-readonly="true" value="<?php echo $paypal ?>" data-width="60" data-height="60" data-fgColor="red">

            <div class="text-muted">PayPal</div>
            </div>
            <!-- ./col -->
            <div class="col-4 text-center">
            <input type="text" class="knob" data-readonly="true" value="<?php echo $payu ?>" data-width="60" data-height="60" data-fgColor="green">

            <div class="text-muted">Payu</div>
            </div>
            <!-- ./col -->
            <div class="col-4 text-center">
            <input type="text" class="knob" data-readonly="true" value="<?php echo $mercadoPago ?>" data-width="60" data-height="60" data-fgColor="blue">
