...
<div class="col-md-4">
	...
	<div class="card">
		...
		<div class="card-header border-0">
			...
			<h3 class="card-title">Productos recién agregados</h3>
			...
			<ul class="products-list product-list-in-card pl-2 pr-2">
				...
				<li class="item">
					...
					<div class="product-img">
						<img src="<?php echo TemplateController::srcImg()?>views/img/products/<?php echo $value->url_category."/".$value->image_product ?>"
							width="100" class="img-size-50">
					</div>

					<div class="product-info">

						<a href="<?php echo TemplateController::srcImg().$value->url_product ?>"
							target="_blank"><?php echo $value->name_product ?></a>
		...
		<div class="card-footer clearfix">
			<a href="/products" class="btn btn-sm btn-dark float-right">Ver todos los productos</a>
		</div>
